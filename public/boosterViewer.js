...
(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = `
      ...
      .bvHp{top:34%;border-radius:50%;background:radial-gradient(circle at 32% 22%, rgba(255,255,255,.85), transparent 40%), radial-gradient(circle at 68% 82%, rgba(110,0,0,.55), transparent 58%), radial-gradient(closest-side, #ff6a5c 45%, #8a0f0f 100%);border:3px solid #ffcf7a;box-shadow:0 0 5px rgba(255,215,120,.9), 0 0 22px rgba(255,50,40,.55), 0 4px 8px rgba(0,0,0,.55), inset 0 -5px 8px rgba(0,0,0,.45), inset 0 3px 5px rgba(255,255,255,.5);text-shadow:0 1px 3px rgba(0,0,0,.95), 0 0 4px rgba(0,0,0,.7);}
      .bvShield{top:64%;border-radius:0;clip-path:polygon(50% 0%, 100% 16%, 100% 58%, 50% 100%, 0% 58%, 0% 16%);background:linear-gradient(200deg, #eaf8ff 0%, #7dd0ff 32%, #2489c9 68%, #0a3f66 100%);border:2.5px solid rgba(220,245,255,.9);box-shadow:0 0 5px rgba(190,235,255,.9), 0 0 22px rgba(70,195,255,.55), 0 4px 8px rgba(0,0,0,.55), inset 0 3px 5px rgba(255,255,255,.5), inset 0 -5px 8px rgba(0,0,0,.4);color:#eafcff;font-size:22px;text-shadow:0 1px 3px rgba(0,0,0,.95), 0 0 4px rgba(0,0,0,.7);padding-top:3px;}
    `;
