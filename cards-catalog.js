...
const IMPLEMENTED_CODES = [
  ...
  141,142,143,144,145,146,147,148,149,150,                          // Savage (2e lot)
  ...
  188,189,190,191,192,193,194,195,196,197,198,199,200,             // Chimeria (8e lot)
  ...
  237,238,239,240,241,242,243,244,245,246,247,248,249,250,          // Wadoo (7e lot)
];
...
// représente aucune progression). UN SEUL gain par palier sur toute la Voie
// de la Menace : les pièces couvrent donc UNIQUEMENT les tout premiers
// paliers (1-4), avant que SEASON_SKINS ne prenne le relais au palier 5
// (Hostile III), puis SEASON_CARDS pour tous les paliers suivants (6-14) —
// jamais deux récompenses différentes sur le même palier. Distribué via le
// même bouton admin "débloquer les récompenses de rang atteint" que les
// cartes WIN et les skins (voir season_coin_grants dans db.js pour la trace
// anti-doublon).
